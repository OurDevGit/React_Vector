...
const messages = {
  ...
  "CHECK_RESOLUTION": "Kontrola rezolucji.",
  "ERROR_RESOLUTION": "Błąd: błąd wewnętrzny kontrola rozdzielczości",
  ...
  "BROWSER_SUPPORT_TITLE": "Przeglądarka nie jest obsługiwana",
  "BROWSER_SUPPORT_TEXT": "Używana przeglądarka nie jest obsługiwana przez nasze oprogramowanie. Poniżej znajdziesz alternatywne przeglądarki można użyć. Kiedy zostało wybrane alternatywne przeglądarki będziesz mieć możliwość dostępu do sesji link do jego używania.",
  "BROWSER_NAME_EDGE": "Krawędź",
  "BROWSER_VERSIONS_EDGE": "Wszystkie",
  "BROWSER_NAME_CHROME": "Chrome",
  "BROWSER_VERSIONS_CHROME": "Wszystkie",
  "BROWSER_NAME_FIREFOX": "Firefox",
  "BROWSER_VERSIONS_FIREFOX": "Wszystkie",
  "BROWSER_NAME_OPERA": "Opera",
  "BROWSER_VERSIONS_OPERA": "Wszystkie",
  "MORE_SETTINGS": "Więcej ustawień",
  "LESS_SETTINGS": "Mniej ustawień",
  "YOUR_PASSWORD": "Twoje hasło",
  "VERSION": "Wersja: ",
  "GIT_REV": "Git Rev: ",
  "POWERED_BY": "Powered By: ",
  "PREVIOUS": "Poprzedni",
  "SET_LAYOUT_POSITION": "Ustaw pozycję układu.",
  "ENTER_LAYOUT_POSITION": "Proszę podać pozycję układu.",
  "LAYOUT_POSITION": "układ pozycji",
  "DISCONNECTED": "Niepowiązany",
  "CONNECTING": "Złączony",
  "CONNECTED": "Połączony",
  "COM_STATUS": "Stan komunikacji .",
  "SCREEN_SHARE": "Ekran Podziel się",
  "PRESENTER": "Prezenter",
  "WATCHING_CANVAS": "Oglądając Canvas",
  "INPUT_CANVAS": "Wejście na płótnie",
  "CLEAR_ALERTS": "Pogodne Alerts",
  "NO_LOG": "Brak danych dziennika",
  "CLICK_DIAL": "Kliknij , aby wybrać",
  "SETTINGS_LOGIN": "Zaloguj się, aby zmienić ustawienia",
  "SETTINGS_USER": "Ustawienia użytkownika",
  "SETTINGS_USER_LOGIN": "Zaloguj się, aby zmienić ustawienia użytkownika",
  "MENU_INFO": "Informacje Menu",
  "CALL_FROM": "Połącz z:",
  "ANSWER": "Odpowiedź",
  "REJECT": "Odrzucać",
  "ACTIVE": "aktywny",
